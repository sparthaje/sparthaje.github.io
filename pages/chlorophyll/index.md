...
## Hardware
The circuitry for the project was relatively simple. I removed the switch from the wall and put a relay in between where the switch was. The wires entered the normally open pin and exited on the common pin, so when the signal voltage was `HIGH` the circuit would close.
